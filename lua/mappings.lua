...
map("n", "gr", builtin.lsp_references	, { desc = "Lists LSP references for word under the cursor" })
map("n", "gd", builtin.lsp_definitions, { desc = "Goto the definition of the word under the cursor" })
-- NvimTree
